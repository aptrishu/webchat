# Django settings for django_jchat project.

# let's get the path automatically, no manual settings... yay!
import os.path
PATH_ROOT = os.path.dirname(__file__).replace('\\','/')
...
MEDIA_ROOT =  os.path.join(PATH_ROOT, 'static')
...
ROOT_URLCONF = 'django-jchat.urls'
